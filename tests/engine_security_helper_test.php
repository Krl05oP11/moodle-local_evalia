...
/**
 * PHPUnit tests for local_evalia\engine_security_helper.
 *
 * Run from the Moodle root:
 *   vendor/bin/phpunit --filter local_evalia local/evalia/tests/engine_security_helper_test.php
 *
 ...
 * (Same coverage as local_saipa's copy of this class — duplicated on
 * purpose, see the class docblock — kept in sync.)
 *
 ...
 *
 * @covers \local_evalia\engine_security_helper
 */
