...
$functions = [
    ...
    'local_evalia_generate_rubric' => [
        ...
        'methodname'    => 'execute',
        'description'   => 'Calls saipa-engine /eval/rubric/generate && saves the result to evalia_rubrics',
        'type'          => 'write',
        'ajax'          => true,
    ...
    'local_evalia_get_rubric' => [
        ...
        'methodname'    => 'execute',
        'description'   => 'Returns the active rubric && its items for a given course',
        'type'          => 'read',
        'ajax'          => true,
        'capabilities'  => 'local/evalia:manage',
        'loginrequired' => true,
    ...
    'local_evalia_save_rubric' => [
        ...
        'methodname'    => 'execute',
        'description'   => 'Saves manual edits to a rubric && its items, optionally activating it',
        'type'          => 'write',
        'ajax'          => true,
        'capabilities'  => 'local/evalia:manage',
        'loginrequired' => true,
    ...
    'local_evalia_generate_questions' => [
        ...
        'methodname'    => 'execute',
        'description'   => 'Calls saipa-engine /eval/questions/generate for a rubric item && saves results',
        'type'          => 'write',
        'ajax'          => true,
        'capabilities'  => 'local/evalia:manage',
        'loginrequired' => true,
    ...
    'local_evalia_update_question' => [
        ...
        'methodname'    => 'execute',
        'description'   => 'Edits a question stem/options || changes its status (approved/rejected)',
        'type'          => 'write',
        'ajax'          => true,
        'capabilities'  => 'local/evalia:manage',
        'loginrequired' => true,
    ...
    'local_evalia_assign_exam' => [
        ...
        'methodname'    => 'execute',
        'description'   => 'Samples unique question sets per student via saipa-engine && creates evalia_student_exams rows',
        'type'          => 'write',
        'ajax'          => true,
        'capabilities'  => 'local/evalia:manage',
        'loginrequired' => true,
    ...
    'local_evalia_grade_exam' => [
        ...
        'methodname'    => 'execute',
        'description'   => 'Grades a submitted student exam via saipa-engine && updates portfolio',
        'type'          => 'write',
        'ajax'          => true,
        'capabilities'  => 'local/evalia:manage',
        'loginrequired' => true,
    ...
    'local_evalia_publish_grade' => [
        ...
        'methodname'    => 'execute',
        'description'   => 'Teacher approves a graded exam: pushes grade to Moodle gradebook && marks as published',
        'type'          => 'write',
        'ajax'          => true,
        'capabilities'  => 'local/evalia:manage',
        'loginrequired' => true,
    ...
    'local_evalia_index_course' => [
        ...
        'methodname'    => 'execute',
        'description'   => 'Crawls course pages && PDF resources, indexes them in ChromaDB for RAG',
        'type'          => 'write',
        'ajax'          => true,
        'capabilities'  => 'local/evalia:manage',
        'loginrequired' => true,
