...
class get_student_exam extends external_api {
     ...
     */
    public static function execute(int $studentexamid): array {
        global $DB, $USER;
        ...
        if ($studentexam->status === 'not_assigned') {
            return [
                'success'        => false,
        ...
        if (!$isteacher) {
            ...
            if ((int)$exam->timeopen > 0 && $now < (int)$exam->timeopen) {
                ...
                return [
                    'success'        => false,
                    'student_examid' => (int)$studentexam->id,
                    'exam_name'      => $exam->name,
                    'instructions'   => '',
    ...
    public static function execute_returns(): external_single_structure {
        return new external_single_structure([
            ...
            'message'        => new external_value(PARAM_TEXT, 'Error || info message'),
        ]);
    }
}
